...
INSERT INTO User (Id, First_Name, Last_Name, Email, Password, DOB, Address_Line1, City, Phone_Number, Role) VALUES
...
INSERT INTO language (Id, Name) VALUES (6,'Japanese');
...
INSERT INTO Review (Id, Customer_Id, Book_Id, Review, Date) VALUES
...
INSERT INTO Cart (Id, User_Id, Book_Id, Total_Books, Total_Price, Discount) VALUES
(1, 1, 1, 1, 29.99, 0.00),
(2, 1, 5, 2, 41.98, 2.00),
(3, 2, 3, 3, 77.97, 5.00),
(4, 3, 6, 1, 15.99, 0.00),
...
INSERT INTO Orders (Id, Cart_Id, Quantity, Customer_Id, Order_Date, Dest_Address, Status, Payment) VALUES
(1, 1, 1, 1, '2024-11-25', '123 Elm St, New York', 'Shipped', TRUE),
(2, 2, 2, 1, '2024-11-28', '123 Elm St, New York', 'Shipped', TRUE),
(3, 3, 3, 2, '2024-12-03', '456 Oak St, London', 'Pending', FALSE),
(4, 4, 1, 3, '2024-12-07', '789 Pine St, Paris', 'Shipped', TRUE),
(5, 5, 2, 3, '2024-12-11', '789 Pine St, Paris', 'Shipped', TRUE),
(6, 6, 1, 4, '2024-12-12', '654 Maple St, Berlin', 'Delivered', TRUE),
(7, 7, 1, 5, '2024-12-13', '321 Cedar St, New York', 'Shipped', TRUE),
(8, 8, 3, 6, '2024-12-15', '17 Kuomintang St, Shanghai', 'Delivered', TRUE);

INSERT INTO Payment (Id, Customer_Id, Order_Id, Status, Payment_Method) VALUES
